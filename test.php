            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="#">Studio Photography</a>
                        <a class="dropdown-item" href="#">Landscape Photography</a>
...
<div class="row">
    ...
    <div class="container col-md-4">
        ...
        <p>Smith Photography is an Amazing and Creative Photographer.</p>
    </div>
    <div class="col-md-4"></div>
</div>
<div class="row">
    <div class="col-md-4"></div>
    <div class="container col-md-4">
        <img src="resources/test3.jpg" alt="Avatar" style="width:90px">
